...
test_that("simulate.evm functions behave as expected", {
  ...
  expect_more_than(scor(s1, s2), .98, label="Compare simulate.evmSim with rgpd")
  ...
  expect_more_than(scor(s1, s2), .98, label="Compare simulate.evmBoot with rgpd")
  ...
  expect_more_than(scor(s[, 1], s[, 2]), .98)
  ...
  expect_more_than(scor(s1, s2), .85, label="Compare simulate.evmSim with rgev")
  ...
  expect_more_than(scor(s1, s2), .85, label="Compare simulate.evmBoot with rgev")
  ...
  expect_equal(ncol(s), 2)
  expect_more_than(scor(s[, 1], s[, 2]), .85)
