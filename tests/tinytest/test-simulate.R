...
expect_equal(cor(s1, s2), 1, info="Compare simulate.evmOpt with rgpd")
...
expect_true(scor(s1, s2) > .98, info="Compare simulate.evmSim with rgpd")
...
expect_true(scor(s1, s2) > .98, info="Compare simulate.evmBoot with rgpd")
...
expect_equal(cor(s1, s2), 1, info="Compare simulate.evmOpt with rgev")
...
expect_true(scor(s1, s2) > .85, info="Compare simulate.evmSim with rgev")
...
expect_true(scor(s1, s2) > .85, info="Compare simulate.evmBoot with rgev")
