...
test_that("pgpd behaves as it should", {
  ...
  expect_that(upperProb, equals(1),   
  lowerProb <- pgpd(-2/xi, 1, xi, u=0, lower.tail=FALSE)
  expect_that(lowerProb, equals(0), }
)
