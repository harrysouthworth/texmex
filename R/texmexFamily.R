...
#' 
#' The \code{density}, \code{rng}, \code{prob} and \code{quant} functions can
...
#' @param info Function to compute the information matrix. If not provided, the
#' modelling functions will work with a numerical approximation.
#' @param sandwich Function to compute the filling in the Huber sandwich
#' estimator of the covariance matrix of parameter estimates, used for
#' dependent data. Only implemented in family \code{gpd}.
#' @param start Function to compute starting parameters for the model. If not
#' provided, the modelling functions will try to guess.
#' @param resid Function to compute residuals for the model.
#' @param rl Function to compute return levels.
#' @param delta Function to compute adjustments for covariance for return
#' levels.
#' @param endpoint Function to compute the upper or lower endpoint of the
#' fitted distribution.
