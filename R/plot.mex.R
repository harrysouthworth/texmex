...
mySdep2.lap <- mexDependence(smarmod,which=2, dqu=0.8, start = mySdep1.lap )
myWdep2.lap <- mexDependence(wmarmod,which=2, dqu=0.85, start = myWdep1.lap )
mySdep3.lap <- mexDependence(smarmod,which=3, dqu=0.9, start = mySdep1.lap )
myWdep3.lap <- mexDependence(wmarmod,which=3, dqu=0.7, start = myWdep1.lap )
mySdep4.lap <- mexDependence(smarmod,which=4, dqu=0.75, start = mySdep1.lap )
myWdep4.lap <- mexDependence(wmarmod,which=4, dqu=0.8, start = myWdep1.lap )
mySdep5.lap <- mexDependence(smarmod,which=5, dqu=0.85, start = mySdep1.lap )
myWdep5.lap <- mexDependence(wmarmod,which=5, dqu=0.9, start = myWdep1.lap )
