mexTransform <-
function(x, margins, r=NULL, method = "mixture", divisor = "n+1", na.rm = TRUE){ # if required, r output from makeReferenceDistributionForMexTransform
...
makeReferenceDistributionForMexTransform <- function(x,r,whichNoChange=NULL){ 
