...
test_that("mexDependence behaves as it should", {
  ...
  expect_that(jhWdepO3, equals(myWdepO3$dependence$coefficients[1:4), ],tolerance=tol,label="mexDependence:WinterO3")
  ...
  tol <- 0.005
  expect_that(summer.mex1$dependence$coefficients, equals(summer.mex2$dependence$coefficients), tolerance=tol,label="mexDependence:summerstartingvalues:class(start)='mex'")
  expect_that(summer.mex1$dependence$coefficients, equals(summer.mex3$dependence$coefficients), tolerance=tol,label="mexDependence:summerstartingvalues:start=matrix")
  expect_that(summer.mex1$dependence$coefficients, equals(summer.mex4$dependence$coefficients), tolerance=tol,label="mexDependence:summerstartingvalues:start=vector")
  ...
  expect_that(KTPest, equals(HTSest), tolerance=tol,mesg=paste("mexDependence:constrainedestimationthreshold",i))
    }
  }
}
)
