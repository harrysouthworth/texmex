...
test_that("mexDependence behaves as it should", {
  ...
  expect_that(jhWdepO3, equals(myWdepO3$dependence$coefficients[1:4),   expect_that(jhWdepNO2, equals(myWdepNO2$dependence$coefficients[1:4),   expect_that(jhWdepNO, equals(myWdepNO$dependence$coefficients[1:4),   expect_that(jhWdepSO2, equals(myWdepSO2$dependence$coefficients[1:4),   expect_that(jhWdepPM10, equals(myWdepPM10$dependence$coefficients[1:4),   
  expect_that(jhSdepO3, equals(mySdepO3$dependence$coefficients[1:4),   expect_that(jhSdepNO2, equals(mySdepNO2$dependence$coefficients[1:4),   expect_that(jhSdepNO, equals(mySdepNO$dependence$coefficients[1:4),   expect_that(jhSdepSO2, equals(mySdepSO2$dependence$coefficients[1:4),   expect_that(jhSdepPM10, equals(mySdepPM10$dependence$coefficients[1:4),   
  ...
  expect_that(wavesurge.mex[1:2], equals(wavesurge.dep[1:2]),   expect_that(dim(wavesurge.mex$dependence$Z), equals(c(578),   expect_that(wavesurge.mex$dependence$dqu, equals(dqu),   expect_that(wavesurge.mex$dependence$which, equals(which),   
  ...
  tol <- 0.005
  expect_that(summer.mex1$dependence$coefficients, equals(summer.mex2$dependence$coefficients),   expect_that(summer.mex1$dependence$coefficients, equals(summer.mex3$dependence$coefficients),   expect_that(summer.mex1$dependence$coefficients, equals(summer.mex4$dependence$coefficients),   
  ...
  expect_that(KTPest, equals(HTSest),     }
  }
}
)
